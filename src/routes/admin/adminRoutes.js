...
router.get('/api/catalog/products', AdminController.getCatalogProductsAPI);
router.post('/api/catalog/products', AdminController.createCatalogProductAPI);
router.post('/api/catalog/products/:productCode/plans', AdminController.createCatalogProductPlanAPI);
router.get('/api/catalog/clients/:clientId/subscriptions', AdminController.getClientSubscriptionsAPI);
router.post('/api/catalog/clients/:clientId/subscriptions', AdminController.activateClientProductAPI);
router.get('/api/catalog/resellers/:resellerId/permissions', AdminController.getResellerPermissionsAPI);
router.post('/api/catalog/resellers/:resellerId/permissions', AdminController.grantResellerProductPermissionAPI);
